  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Timeline Items or Professional Empty State */}
        {experience.length === 0 ? (
          <div className="p-8 rounded-2xl bg-zinc-50 dark:bg-[#141414] border border-zinc-200 dark:border-white/5 text-center max-w-xl mx-auto space-y-3">
            <h3 className="text-base font-bold text-zinc-900 dark:text-white">
              Project-Based Track Record
            </h3>
